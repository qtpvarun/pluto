...
import com.btgrp.protrack.repository.DepartmentRepository;
import com.btgrp.protrack.service.DepartmentService;
...
public class DepartmentResourceIT {
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.isActiveFlag()).isEqualTo(DEFAULT_ACTIVE_FLAG);
    }
    ...
    public void getAllDepartmentsWithEagerRelationshipsIsEnabled() throws Exception {
        DepartmentResource departmentResource = new DepartmentResource(departmentServiceMock);
    ...
    public void updateDepartment() throws Exception {
        ...
        assertThat(testDepartment.isActiveFlag()).isEqualTo(UPDATED_ACTIVE_FLAG);
    }
