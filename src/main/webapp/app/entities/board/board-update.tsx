...
export interface IBoardUpdateState {
  isNew: boolean;
}

export class BoardUpdate extends React.Component<IBoardUpdateProps, IBoardUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/board');
  };

  render() {
    const { boardEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="proTrackApp.board.home.createOrEditLabel">
              <Translate contentKey="proTrackApp.board.home.createOrEditLabel">Create or edit a Board</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : boardEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="board-id">
                ...
                <AvGroup>
                  <Label id="boardFilterLabel" for="board-boardFilter">
                    <Translate contentKey="proTrackApp.board.boardFilter">Board Filter</Translate>
                  </Label>
                  <AvField id="board-boardFilter" type="text" name="boardFilter" />
                </AvGroup>
                <Button tag={Link} id="cancel-save" to="/entity/board" replace color="info">
